...
execute_process(
  COMMAND "/usr/bin/git" show-ref "6b74da4757a549563d7c37c8fae3e704662a043b"
  WORKING_DIRECTORY "/home/creapermann/Programming/Cpp/Qt/Qml/ToDo-App/build-Debug/_deps/googletest-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "6b74da4757a549563d7c37c8fae3e704662a043b")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("6b74da4757a549563d7c37c8fae3e704662a043b" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/6b74da4757a549563d7c37c8fae3e704662a043b")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/creapermann/Programming/Cpp/Qt/Qml/ToDo-App/build-Debug/_deps/googletest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/creapermann/Programming/Cpp/Qt/Qml/ToDo-App/build-Debug/_deps/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
